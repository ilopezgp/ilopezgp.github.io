...
categories: journal
tags: [generative AI, climate models]
image: DynGenDown-1-Cartoon.width-1250.png
---

*This research post first appeared in the Google Research [blog](https://research.google/blog/).*
...
| ![DynGenDown-1-Cartoon.width-1250.png](/assets/img/DynGenDown-1-Cartoon.width-1250.png) | 
|:--:| 
| **Figure 1:** *Downscaling methods increase the resolution of climate projections over limited-area regions of the Earth. This enables us to understand the effect of topography and regional processes on weather extremes. Rendering generated by [Imagen 3](https://deepmind.google/technologies/imagen-3/).* |
...
## A more efficient approach: Physics meets generative AI
...
## Efficient and reliable regional climate projections
